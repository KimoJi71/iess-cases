/*
 * shell/reports-sidebar.js — 報表統計左側選單
...
(function () {
  ...
  function ReportsSidebar(props) {
    ...
    return h('aside', {
      ...
      h('div', { className: 'p-4 border-b border-gray-100 bg-gray-50/50' },
        h('h2', { className: 'text-base font-bold text-gray-700 tracking-wide' }, '報表統計 選單')
      ),
  ...
  window.ReportsSidebar = ReportsSidebar;
})();
