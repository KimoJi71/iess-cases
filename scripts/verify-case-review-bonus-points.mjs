  ...
  await evaluate(`
    window.__fixtureCases = [
      { id: 'R1', caseNumber: 'BP001', customerName: 'C級客戶', storeName: '門市一',
        ...
        repairReason: '不冷', isClosed: true,
        closeDate: '${todayDate} 10:00',
        serviceItems: [{ id: 'SI1', equipment: null, actualReason: '缺冷媒',
      ...
      { id: 'R2', caseNumber: 'BP002', customerName: 'A級客戶', storeName: '門市二',
        ...
        repairReason: '異音', isClosed: true,
        closeDate: '${todayDate} 10:00',
        serviceItems: [{ id: 'SI1', equipment: { model: 'M-1', equipmentLevel: '增額設備' },
          actualReason: '軸承', processRecords: [{ points: 4, qty: 1 }] }] },
      { id: 'R3', caseNumber: 'BP003', customerName: 'B級客戶', storeName: '門市三',
        serviceLevel: 'B 保修(一年兩次)', workCategory: '一般叫修', repairItem: '冷氣',
        repairReason: '漏水', isClosed: true,
        closeDate: '${todayDate} 10:00',
        serviceItems: [{ id: 'SI1', equipment: { model: 'M-1', equipmentLevel: '一般設備' },
          actualReason: '排水管', processRecords: [{ points: 9, qty: 1 }] }] },
      { id: 'R4', caseNumber: 'BP004', customerName: 'D級客戶', storeName: '門市四',
        serviceLevel: 'D 維修(無簽約客戶)', workCategory: '一般叫修', repairItem: '冷氣',
        repairReason: '不運轉', isClosed: true,
        closeDate: '${todayDate} 10:00',
        serviceItems: [{ id: 'SI1', equipment: null, actualReason: '電容', processRecords: [] }] },
