...
舊案件的單一設備會自動遷移為一張卡片。
案件排程 →「人員動向」的日曆可切換「案件」與「工作安排」兩種內容：
案件（叫修／保養／立案）依指定日期＋組別查詢，卡片比照「案件安排」在組別下方顯示協力廠商，
只掛協力廠商、沒有正式組別的案件不進日曆；工作安排依指定日期＋指派人員（選項取自帳號管理）查詢，
卡片顯示工作名稱與指派人員，沒填預計日期的工作安排不會出現在日曆與清單。
